...
public partial class App
{
    ...
    public const string APP_VERSION = "1.3.2"; // Should always be update after every update and needs to match the release tagname.
    ...
    private void SetupCulture()
    {
        ...
        if (new List<string>{"ja", "en-US", "zh-CN", "ru", "pl"}.Contains(setCulture))
        {
