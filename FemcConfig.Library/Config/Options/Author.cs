...
public record Author(string Name, string? Description = null, string? Url = null)
{
    ...
    public static readonly Author Chrysanthie = new("Chrysanthie", Url: "https://x.com/PatManDX");
    public static readonly Author Fernando = new("Fernando", Url: "https://x.com/PatManDX");
    public static readonly Author Monica = new("Monica", Url: "https://x.com/PatManDX");
    public static readonly Author Mosq = new("Mosq", Url: "https://x.com/PatManDX");
    public static readonly Author Atlus = new("Atlus", Url: "https://x.com/PatManDX");
    public static readonly Author Mudkip = new("MadMax1960", Url: "https://x.com/PatManDX");
};
