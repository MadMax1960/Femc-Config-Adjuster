...
/// </summary>
public class ReloadedModConfig
{
    ...
    */
    ...
    public ConfigColor MindWindowOuterBorderNew { get; set; } = ConfigColor.MindWindowOuterBorder;

    [DisplayName("Mind Window: Inner Color")]
    public ConfigColor MindWindowInnerColorNew { get; set; } = ConfigColor.MindWindowInnerColor;
    ...
    */
    ...
    [Category("Ui Colors")]
    public ConfigColor MindWindowBgDotsNew { get; set; } = ConfigColor.MindWindowOuterBorder;
    ...
    public ConfigColor CheckPromptBackBoxColorNew { get; set; } = ConfigColor.CheckPromptBgBox;
    ...
    public ConfigColor CheckPromptFrontBoxColorHighNew { get; set; } = ConfigColor.CheckPromptFgBox;
    ...
    [Category("Ui Colors")]
    public ConfigColor NetworkDailyActionStickyNoteBgColor1 { get; set; } = ConfigColor.NetStickyNoteBgColor1;
    ...
    [Category("Ui Colors")]
    public ConfigColor NetworkDailyActionStickyNoteTextColor1 { get; set; } = ConfigColor.NetStickyNoteTextColor1;
    ...
    public ConfigColor CampStatusInactiveMemberBgTartarus { get; set; } = ConfigColor.InactivePartyMemberTartarusBG;

    [DisplayName("Camp Status: Inactive Member Details Pale Pink (Tartarus)")]
    public ConfigColor CampStatusInactiveMemberDetailsPalePinkTartarus { get; set; } = ConfigColor.InactivePartyMemberPalePink;

    [DisplayName("Camp Status: Inactive Member Details Dark Pink (Tartarus)")]
    public ConfigColor CampStatusInactiveMemberDetailsDarkPinkTartarus { get; set; } = ConfigColor.InactivePartyMemberDarkPink;

    [DisplayName("Camp Status: Inactive Member HP Bar (Tartarus)")]
    public ConfigColor CampStatusInactiveMemberHPBarTartarus { get; set; } = ConfigColor.InactivePartyMemberHPColor;
    ...
    public ConfigColor LocationSelMapLabel { get; set; } = ConfigColor.LocationSelectMapLabel;
